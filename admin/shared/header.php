  ...
  <div class="header-left">
    ...
    <a href="index.php" class="logo">
      <img src="assets/img/logo.png" alt="Logo">
          ...
          <ul>
            ...
            <li class="relative px-6 py-3">
              ...
              >
                ...
                <span class="ml-4">Services Provider</span>
              </a>
            </li>
            <li class="relative px-6 py-3">
              <a
                class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                href="active_service_provider.php"
              >
                <svg
                  class="w-5 h-5"
                  aria-hidden="true"
                ...
                <span class="ml-4">Active Provider</span>
              </a>
            </li>
            <li class="relative px-6 py-3">
              <a
                class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                href="subcription.php";
            ...
            <li class="relative px-6 py-3">
              ...
              >
                ...
                <span class="ml-4">Active Subscription</span>
              </a>
            </li>
            <li class="relative px-6 py-3">
              <a
            ...
            <li class="relative px-6 py-3">
              ...
              >
                ...
                <span class="ml-4">Pricing Management</span>
              </a>
            </li>
            <li class="relative px-6 py-3">
              <a
              ...
              >
                ...
                <span class="ml-4">Pricing List</span>
              </a>
            </li>
          ...
          > Create account
          <span class="ml-2" aria-hidden="true">+</span></a>
            ...
            <ul class="flex items-center flex-shrink-0 space-x-6">
              ...
              <li class="relative">
                ...
                >
                  ...
                  <span
                    aria-hidden="true"
                    class="absolute top-0 right-0 inline-block w-3 h-3 transform translate-x-1 -translate-y-1 bg-black border-2 border-white rounded-full dark:border-gray-800"
                  ></span>
                </button>
